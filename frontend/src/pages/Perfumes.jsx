...
const Parfums = () => {
  ...
  useEffect(() => {
    getProductsByCategory("Parfums", localSearch);
  }, [
    filters.gender,
    filters.maxPrice,
    filters.sort,
      ...
      <div className="costum-section">
        ...
        >
          ...
          >
            ...
            <span className="text-secondary">Parfums de Luxe</span>
          </motion.h1>
          <motion.p
          ...
          >
            Découvrez notre collection exclusive de parfums soigneusement
            sélectionnés
          </motion.p>
        </motion.div>
        ...
        {!loading && products.length === 0 && (
          ...
          >
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-primary mb-2">
              {localSearch ? "Aucun parfum trouvé" : "Aucun parfum disponible"}
            </h3>
            <p className="text-primary/80 mb-6 text-sm sm:text-base">
              {localSearch
                ? `Désolé, aucun parfum ne correspond à "${localSearch}"`
