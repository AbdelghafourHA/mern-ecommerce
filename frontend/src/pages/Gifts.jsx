...
const Gifts = () => {
  ...
  useEffect(() => {
    getProductsByCategory("Cadeaux", localSearch);
  }, [
    filters.gender,
    filters.maxPrice,
    filters.sort,
      ...
      <div className="costum-section">
        ...
        >
          ...
          >
            ...
            <span className="text-secondary">Coffrets et Cadeaux de Luxe</span>
          </motion.h1>
          <motion.p
        ...
        >
          <SearchPanel
            ...
            placeholder="Rechercher un coffret cadeau par nom..."
          />
        </motion.div>
          ...
          >
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-primary mb-2">
              {localSearch
                ...
                : "Aucun coffret cadeau disponible"}
            </h3>
            <p className="text-primary/80 mb-6 text-sm sm:text-base">
              {localSearch
                ? `Désolé, aucun coffret ne correspond à "${localSearch}"`
